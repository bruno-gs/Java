...
public class ClienteBanco {
    ...
    public boolean abreConta(tipoConta tipo) {
        ...
        switch (tipo) {
            ...
            case CORRENTE:
                this.contaCC = new Corrente(500, tlr.nextInt(1000000, 9999998 + 1), 0);
                return true;                
            case SALARIO:
                this.contaSalario = new Salario(tlr.nextInt(1000000, 9999998 + 1), 0);
                return true;
            default:
                System.out.println("Tipo de conta invalido");
                return false;
    ...
    public Salario getContaSalario() {
        return contaSalario;
    }
    public void setContaSalario(Salario salario) {
